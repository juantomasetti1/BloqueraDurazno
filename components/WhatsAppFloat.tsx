...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="wa-pulse fixed bottom-6 right-6 z-50 bg-green-whatsapp hover:bg-green-dark text-white w-16 h-16 flex items-center justify-center shadow-2xl transition-colors"
